...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People were not being added to the queue correctly, they were inserted at the front instead of added to the back
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim was not being added back to the queue, so an unexpected result error was flagged.
    ...
    // Defect(s) Found: people with negative turns remaining were not being added back to the queue
